...
public class AdminService {
    ...
    public Student createStudent(Student student) {
        ...
        return mongoTemplate.insert(new Student(student.getUsername(), passwordEncoder.encode(student.getPassword()),
                student.getName(), student.getStudentId(), student.getEmail(), student.getPhoneNumber()), "users");
    }
